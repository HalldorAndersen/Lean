...
class MeanReversionIBSAlphaModel(AlphaModel):
    ...
    def __init__(self, *args, **kwargs): 
        ...
        self.numberOfStocks = kwargs['numberOfStocks'] if 'numberOfStocks' in kwargs else 1
    ...
    def Update(self, algorithm, data):
        ...
        for key,value in highIBS.items():
            insights.append(Insight.Price(key, self.predictionInterval, InsightDirection.Down, 0, None))
